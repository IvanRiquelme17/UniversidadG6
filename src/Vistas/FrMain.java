...
public class FrMain extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenuManejoInsc = new javax.swing.JMenuItem();
        jMenuNotas = new javax.swing.JMenu();
        jMenuManipularNotas = new javax.swing.JMenuItem();
        ...
        jMenuFormMat.setText("Formulario de materias");
        jMenuMateria.add(jMenuFormMat);

        jMenuBar2.add(jMenuMateria);

        jMenuAlumno.setText("Alumnos");

        jMenuFormAlum.setText("Formulario de alumnos");
        jMenuFormAlum.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuFormAlumActionPerformed(evt);
            }
        });
        jMenuAlumno.add(jMenuFormAlum);

        jMenuBar2.add(jMenuAlumno);

        jMenuInsc.setText("Inscripciones");

        jMenuManejoInsc.setText("Manejo de Inscripciones");
        jMenuInsc.add(jMenuManejoInsc);

        jMenuBar2.add(jMenuInsc);

        jMenuNotas.setText("Carga de Notas");

        jMenuManipularNotas.setText("Manipulación de notas");
        jMenuNotas.add(jMenuManipularNotas);

        jMenuBar2.add(jMenuNotas);

        jMenuConsultas.setText("Consultas");

        jMenuListado.setText("Listado de Alumnos y Materias");
        jMenuConsultas.add(jMenuListado);

        jMenuBar2.add(jMenuConsultas);
    ...
    private javax.swing.JMenuItem jMenuManejoInsc;
    private javax.swing.JMenuItem jMenuManipularNotas;
